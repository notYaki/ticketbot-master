...
module.exports.run = async (bot, message, args) => {
  ...
  .setDescription(`\n\nHola ${message.author},\n\nGracias por hacer un Ticket. El **STAFF** te ayudará lo antes posible..\n\n**Ticket Catergory:** ${topic1}`)
  ...
  .setFooter(`Esto caducará en 10 segundos y luego se te pondrá en un cooldown de 5 minutos.`)
